...
public class PlainOutputTerminal extends PlainTerminal {
  public PlainOutputTerminal(String name, TransformChain transformChain, IntOrEventualClass type) {
    super(name, transformChain, type);
  }
  
  @Override
  public boolean canConnectTo(Terminal t) {
    //TODO Allow sub/superclassing, whichever makes sense
    if (t instanceof PlainInputTerminal && ((PlainInputTerminal)t).type.isAssignableFrom(this.type)) {
